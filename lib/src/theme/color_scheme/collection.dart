...
@immutable
class TwixColorSchemeCollection extends TwixColorScheme {
  const TwixColorSchemeCollection({
    ...
    required super.errorForeground,
  ...
  const TwixColorSchemeCollection.light({
    ...
    super.errorForeground = const Color(0xfff8fafc),
  ...
  const TwixColorSchemeCollection.dark({
    ...
    super.error = const Color(0xff7f1d1d),
    super.errorForeground = const Color(0xfff8fafc),
