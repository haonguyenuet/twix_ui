...
class TwixCardTheme {
  ...
  TwixCardTheme mergeWith(TwixCardTheme? other) {
  ...
  TwixCardTheme copyWith({
    ...
    return TwixCardTheme(
      ...
      rowCrossAxisAlignment: rowCrossAxisAlignment ?? this.rowCrossAxisAlignment,
      columnMainAxisAlignment: columnMainAxisAlignment ?? this.columnMainAxisAlignment,
      columnCrossAxisAlignment: columnCrossAxisAlignment ?? this.columnCrossAxisAlignment,
