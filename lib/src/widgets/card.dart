          ...
          Flexible(
            child: Column(
              ...
              children: [
                if (title != null)
                  DefaultTextStyle(
                    style: theme.textTheme.titleLarge.copyWith(color: theme.colorScheme.cardForeground),
                    child: title!,
                  ),
                if (description != null)
                  DefaultTextStyle(
                    style: theme.textTheme.bodyMedium.copyWith(color: theme.colorScheme.foreground),
                    child: description!,
                  ),
